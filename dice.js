...
// alert("2. Roll the rooms & weapons dice four separate times to see which rooms/weapons make you most suspicous:");
...
// alert("3. Roll the characters die for four more leads.");
for(let i = 0; i < arrayWithinArray.length; i++){
...
//  }
    ...
    // alert ("5. We are getting close to solving the case. Roll the dice three times to narrow down the search.");
    for(let i = 0; i < arrayWithinArray.length; i++){
...
// alert ("The gang found more evidence- But you have to know the right people. Roll the 5-sided dice and if you land on an odd number you will recieve a hint. Press OK to roll die.");
    ...
    switch(pickHint){
            ...
            case "2":
                ...
                break;
            case "3":
                // alert("Looks like you're friends with the right people, because you landed on a 3! Here it is: We found a hidden photograph of the butler in " + solution[0] + "'s pocket, with a red X running through it.");
                break;
            case "4":
...
// prompt ("6. The gig is up! Who do you want to accuse as the murder? Type 1 to pick " + arrayWithinArray[0] + ", Type 2 to pick " + arrayWithinArray[1] + ", Type 3 to pick " + arrayWithinArray[2] + ".");
let pickSuspect = arrayWithinArray[rollingDice(3)-1];
switch(pickSuspect){
        case arrayWithinArray[0] = "1":
            // alert("You are picking " + arrayWithinArray[0][0] + ", in the " + arrayWithinArray[0][1] + ", with the " + arrayWithinArray[0][2] + ".");
            break;
        case arrayWithinArray[1] = "2":
            // alert("You are picking " + arrayWithinArray[1][0] + ", in the " + arrayWithinArray[1][1] + ", with the " + arrayWithinArray[1][2] + ".");
            break;
        case arrayWithinArray[2] = "3":
            // alert("You are picking " + arrayWithinArray[2][0] + ", in the " + arrayWithinArray[2][1] + ", with the " + arrayWithinArray[2][2] + ".");
            break;
}

// Roll the Verdict Dice
alert("Roll the Verdict Dice to see if you were right!");
